...
<div class="form-group">
    ...
    {!! Form::input('date', 'active_from', isset($offer) ? $offer->active_from ? $offer->active_from->format('Y-m-d') : null : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">
    {!! Form::label('Окончание активности') !!}
    {!! Form::input('date', 'active_till', isset($offer) ? $offer->active_till ? $offer->active_till->format('Y-m-d') : null : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">

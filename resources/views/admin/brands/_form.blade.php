...
<div class="form-group">
    ...
    {!! Form::input('date', 'active_from', isset($brand) ? $brand->active_from ? $brand->active_from->format('Y-m-d') : null : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">
    {!! Form::label('Окончание активности') !!}
    {!! Form::input('date', 'active_till', isset($brand) ? $brand->active_till ? $brand->active_till->format('Y-m-d') : null : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">
...
<div class="form-group">
    @if(isset($brand) && isset($brand->preview_picture))
...
<div class="form-group">
    @if(isset($brand) && isset($brand->detail_picture))

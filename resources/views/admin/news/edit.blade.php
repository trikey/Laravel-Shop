...
<div class="form-group">
    ...
    {!! Form::input('date', 'active_from', $article->active_from ? $article->active_from->format('Y-m-d') : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">
    {!! Form::label('Окончание активности') !!}
    {!! Form::input('date', 'active_till', $article->active_till ? $article->active_till->format('Y-m-d') : null, array('class' => 'form-control')) !!}
</div>
<div class="form-group">
